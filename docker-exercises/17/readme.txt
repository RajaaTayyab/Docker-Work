...
-------------------------------- Run instructions --------------------------------
Run an alpine container with an environment variable called tmpvar set to test. Export that alpine container to an archive, extract the contents of the archive. Do you see the same metadata files from the previous exercise?
